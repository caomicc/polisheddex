...
cp output/pokemon_base_data.json public/output/ 2>/dev/null || echo "Warning: Could not copy pokemon_base_data.json"
...
cp output/manifests/pokemon_base_data.json public/output/manifests/ 2>/dev/null || echo "Warning: Could not copy pokemon_base_data.json"
