              ...
              <div className="flex flex-col space-y-6">
                ...
                <Link href="/items" className="group">
                  <Card className="gap-2 py-4 md:py-6">
                    ...
                    <CardContent className="text-sm px-4 md:px-6">
                      <p>Explore all items in the game and discover their effects and locations.</p>
                    </CardContent>
                    <CardFooter className="text-sm px-4 md:px-6">
                      <CardAction className="text-blue-600 font-medium group-hover:underline">
                        View Items &rarr;
              ...
              <ol className="relative border-s border-border pl-6 space-y-8">
                <li className="flex items-start gap-4">
                  <div>
                    ...
                    <span className="block text-muted-foreground text-xs mt-1 ml-1">
                      At this point I have spent more time on this than actually playing the game. I
                      built this because I wanted a guide to help me play the game, and I am still
                      working on it to make it better for myself and others.
                    </span>
                    <span className="block text-muted-foreground font-medium text-xs mt-1 ml-1">
                      I appreciate the patience as I work through the differences between the
                      faithful vs polished versions of the game. I do understand that the
                      perspective of this not being ready for use because of the differences not
                      beging fully documented but I am only one person and I am trying very hard!
                    </span>
                ...
                <li className="flex items-start gap-4">
                  <div>
                    ...
                    <span className="block text-muted-foreground text-xs mt-1 ml-1">
                      *Currently only basic location data is available + not all locations are
                      included (cough, Pokemon found through headbutt)
                    </span>
                    <span className="inline-block mt-2 px-2 py-0.5 text-xs rounded bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-200">
                      In Progress
                    </span>
