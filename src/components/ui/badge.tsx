  ...
  // 'inline-flex items-center justify-center rounded-sm border px-1 md:px-2 md:px-3 py-[2px] md:py-1 text-[10px] md:text-xs uppercase tracking-wider font-bold w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive transition-[color,box-shadow] overflow-hidden',
  {
    variants: {
      variant: {
        ...
        roaming: 'bg-red-100 text-red-900 border-red-200',
        ...
        morning: 'bg-yellow-100 text-yellow-900 border-yellow-200',
        day: 'bg-sky-100 text-sky-900 border-sky-200',
        nite: 'bg-purple-100 text-purple-900 border-purple-200',
        night: 'bg-purple-100 text-purple-900 border-purple-200',
        ...
        mt: 'bg-green-100 text-green-900 border-green-200',
        pokeball: 'bg-red-100 text-red-900 border-red-200',
        ball: 'bg-red-100 text-red-900 border-red-200',
        ...
        static: 'bg-blue-100 text-blue-900 border-blue-200',
        ...
        npc: 'bg-purple-100 text-purple-900 border-purple-200',
        'For sale': 'bg-purple-100 text-purple-900 border-purple-200',
        'Visible item': 'bg-purple-100 text-purple-900 border-purple-200',
        'Hidden item': 'bg-purple-100 text-purple-900 border-purple-200',
        Common: 'bg-purple-100 text-purple-900 border-purple-200',
        gift: 'bg-purple-100 text-purple-900 border-purple-200',
