...
export const Hero: React.FC<HeroProps> = ({ ...props }) => {
  ...
  return (
    <div
      ref={heroRef}
      className={cn(
        'relative flex flex-col text-left min-h-[200px] lg:min-h-[200px] justify-end p-4 md:p-8 pt-22 bg-gray-900 dark:bg-white/5 rounded-xl mb-8 gap-1 max-w-4xl md:mx-auto shadow-lg',
        className,
      )}
      style={combinedStyle}
    >
